...
# lab_hr=Label(clock, text="12",font=('Time New Roman', 60,"bold"),
#              bg='red',fg='white')
...
# lab_min=Label(clock, text="12",font=('Time New Roman', 60,"bold"),
#              bg='red',fg='white')
...
# lab_sec=Label(clock, text="12",font=('Time New Roman', 60,"bold"),
#              bg='red',fg='white')
...
# lab_am=Label(clock, text="12",font=('Time New Roman', 50,"bold"),
#              bg='red',fg='white')
...
# lab_date=Label(clock, text="12",font=('Time New Roman', 60,"bold"),
#              bg='red',fg='white')
...
# lab_month=Label(clock, text="12",font=('Time New Roman', 60,"bold"),
#              bg='red',fg='white')
# lab_month.place(x=340,y=270, height=110,width=100)

# lab_month_txt=Label(clock, text="month",font=('Time New Roman', 25,"bold"),
#              bg='red',fg='white')
# lab_month_txt.place(x=340,y=410, height=30,width=100)


# lab_year=Label(clock, text="12",font=('Time New Roman', 60,"bold"),
#              bg='red',fg='white')
...
# lab_day=Label(clock, text="12",font=('Time New Roman', 40,"bold"),
#              bg='red',fg='white')
